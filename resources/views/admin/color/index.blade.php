    ...
    @section('admin_content')
                    ...
                    <div class="col-md-12">
                        <div class="orderListArea">
                            <div class="canvas_header">
                                <h2>{{$title}}</h2>
                                <a href="{{url('admin/color-create-store')}}" class="btn btn-default btn-primary">Create Colors
                                </a>
                            </div>  
                                ...
                                <table class="dashboard_Order_status" id="datatable">
                                  ...
                                  <tbody>
                                    ...
                                    <tr>
                                      ...
                                      <td>{{ $row->name}}</td>
                                      <td class="p-0">
                                          <span data-toggle="tooltip" data-placement="top" title="{{ $row->code}}" style="border: 2px solid #8996ff;border-radius: 6px;width:40px;height:40px;display:inline-block;background-color: {{ $row->code}}"></span>
                                      </td>
                                      <td class="p-0">
                                      	@if($row->status == 1)
                                      ...
                                      <td class="m-0">
                                      	<a href="{{url('admin/color-edit-update/'.$row->id) }}" style="padding:6px 10px;" class="btn btn-sm btn-info"><i class="fa fa-edit"></i></a>
                                      </td>
                                    </tr>
                                    @endforeach
                                  </tbody>
        ...
        <script type="text/javascript">
            ...
            $(".updateSectionStatus").click(function(e){
              ...
              $.ajax({
                type:'post',
                url: '{{url("admin/status-color-update")}}',
