    ...
    <div class="sl-mainpanel">
      ...
      <div class="sl-pagebody">
          ...
          <h6 class="card-body-title">SEO Setting
               <a href="{{url('for-admin-new-later-subs-seo')}}" class="btn btn-sm btn-warning" style="float: right;">Back Page</a>
          </h6>
          <p class="mg-b-20 mg-sm-b-30">New Post add form</p>
          <form action="{{url('for-admin-new-later-subs-seo-update')}}" method="post">
          	@csrf
