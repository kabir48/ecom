    ...
    <div class="product_area mt_40">
        <div class="container">
            <div class="porduct_wrapper">
                ...
                <?php
                    $getCategory=App\Model\Admin\Category::where('status',1)->where('section_id',$section['id'])->select('id','category_name')->where('category_name','men_kits')->orderBy('id','DESC')->get()->toArray();
                        //dd($getpros);
                ?>
